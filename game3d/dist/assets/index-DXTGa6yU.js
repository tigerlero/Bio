...
#define LOW_PRECISION`),t}function _p(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===pl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ml?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===un&&(t="SHADOWMAP_TYPE_VSM"),t}function vp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bi:case wi:t="ENVMAP_TYPE_CUBE";break;case Ys:t="ENVMAP_TYPE_CUBE_UV";break}return t}function xp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case wi:t="ENVMAP_MODE_REFRACTION";break}return t}function Mp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case gl:t="ENVMAP_BLENDING_MULTIPLY";break;case yc:t="ENVMAP_BLENDING_MIX";break;case Sc:t="ENVMAP_BLENDING_ADD";break}return t}function yp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Sp(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=_p(e),c=vp(e),u=xp(e),d=Mp(e),f=yp(e),p=cp(e),g=hp(r),v=s.createProgram();let m,h,b=e.glslVersion?"#version "+e.glslVersion+`
...
${a.skills.join(", ")}`)}))}o||a?(this.labelEl.textContent=o?"Press E to return":"Press E for details",this.labelEl.style.display="block"):this.labelEl.style.display="none"}returnHome(){this.labelEl.style.display="none",le.get().stopBgm(.2),this.onReturn()}resize(t,e){this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}destroy(){this.scene.traverse(t=>{t instanceof yt&&(t.geometry.dispose(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose())})}}function ul(i,t,e){return Math.max(t,Math.min(e,i))}function dl(i,t,e,n){return Math.sqrt((i-e)**2+(t-n)**2)}function jl(i=300){return new Promise(t=>{let e=document.getElementById("fade-overlay");e||(e=document.createElement("div"),e.id="fade-overlay",e.style.cssText="position:fixed;inset:0;background:#000;z-index:999;pointer-events:none;opacity:1;transition:opacity 0s;",document.body.appendChild(e)),e.style.transition="none",e.style.opacity="1",e.style.pointerEvents="none",e.offsetHeight,requestAnimationFrame(()=>{e.style.transition=`opacity ${i}ms ease`,e.style.opacity="0",setTimeout(t,i)})})}function Lm(i=300){return new Promise(t=>{let e=document.getElementById("fade-overlay");e||(e=document.createElement("div"),e.id="fade-overlay",e.style.cssText="position:fixed;inset:0;background:#000;z-index:999;pointer-events:none;opacity:0;transition:opacity 0s;",document.body.appendChild(e)),e.style.transition="none",e.style.opacity="0",e.offsetHeight,requestAnimationFrame(()=>{e.style.transition=`opacity ${i}ms ease`,e.style.opacity="1",setTimeout(t,i)})})}Di.get();const ye=new em({antialias:!0});ye.setSize(window.innerWidth,window.innerHeight);ye.shadowMap.enabled=!0;ye.shadowMap.type=ml;ye.setPixelRatio(Math.min(window.devicePixelRatio,2));document.getElementById("game").appendChild(ye.domElement);const vi=new um,xi=new dm;let Zl=!1,me=null,he=null,ge=null,tn=null;async function dn(i){await Lm(250),fl(),i==="TitleScene"?(ge=new Tm(ye,()=>{fl(),dn("OverworldScene")}),tn=new rl(dn)):i==="OverworldScene"?(le.get().init(),le.get().playBgm(),me=new Em(ye,dn,vi,xi),tn=new rl(dn)):i==="EducationCampusScene"?he=new bm(ye,()=>dn("OverworldScene"),vi,xi):i==="ProjectParkScene"?he=new wm(ye,()=>dn("OverworldScene"),vi,xi):i==="JobDistrictScene"?he=new Rm(ye,()=>dn("OverworldScene"),vi,xi):i==="SkillGardenScene"&&(he=new Pm(ye,()=>dn("OverworldScene"),vi,xi)),await jl(250)}function fl(){me&&(me.destroy(),me=null),he&&(he.destroy(),he=null),ge&&(ge.destroy(),ge=null),tn&&(tn.destroy(),tn=null)}async function Dm(){const i=document.getElementById("loading-screen");i&&(i.style.display="flex"),await new Promise(t=>setTimeout(t,400)),i&&(i.style.display="none"),await jl(300),dn("TitleScene")}Dm();document.addEventListener("keydown",i=>{i.key==="Escape"&&tn&&(me||ge)&&!vi.getIsActive()&&!xi.getIsOpen()&&(tn.getIsOpen()?tn.close():tn.open(),Zl=tn.getIsOpen())});const Im=new cm;function Kl(){requestAnimationFrame(Kl);const i=Math.min(Im.getDelta(),.05);if(Zl){ye.render((me==null?void 0:me.scene)||(he==null?void 0:he.scene)||(ge==null?void 0:ge.scene),(me==null?void 0:me.camera)||(he==null?void 0:he.camera)||(ge==null?void 0:ge.getCamera()));return}ge?(ge.update(i),ye.render(ge.scene,ge.getCamera())):me?(me.update(i),ye.render(me.scene,me.camera)):he&&(he.update(i),ye.render(he.scene,he.camera))}Kl();window.addEventListener("resize",()=>{const i=window.innerWidth,t=window.innerHeight;ye.setSize(i,t),ge&&ge.resize(i,t),me&&me.resize(i,t),he&&he.resize(i,t)});
